...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFF77A9);
  late Color tertiary = const Color(0xFFFFC1E3);
  late Color alternate = const Color(0xFFFF4081);
  late Color primaryText = const Color(0xFF333333);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFCE4EC);
  late Color accent1 = const Color(0xFFFFD54F);
  late Color accent2 = const Color(0xFF81C784);
  late Color accent3 = const Color(0xFF4FC3F7);
